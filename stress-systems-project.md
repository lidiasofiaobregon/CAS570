...
Conversely, individual's who did not die from stress but rather from old age seemed to have high levels of "health score" and low levels of "bad social history" and "unsafety" (see screenshot below). 

<img width="1153" alt="Screenshot 2023-12-05 at 5 01 54 PM" src="https://github.com/lidiasofiaobregon/CAS570/assets/117681452/4fee2b42-ab26-41bd-900e-8db9a047eda0">

I believe I've made progress to understanding the Big Picture questions of how social interaction and stress relate to one another over time, how they interact to produce disease, and what kinds of individual differences contribute to stress levels within the population. I've explored how increases in number of social interactions don't necessarily directly contribute to increases or decreases in stress unilaterally, but that it's a matter of an individual's configuration of parameters. I've explored how certain parameters such as levels of "unsafety" and "bad social history" contribute highly to stress-based mortality (within this model). Starting with high levels of these parameters makes it more likely to "die" quickly upon multiple interactions. I've also explored how high levels of "health score", low levels of "unsafety" and low levels of "bad social history" seem to be protective against stress-based mortality, despite having multiple social interactions. Additionally, I've explored how, despite diversity across individual parameter configurations, the mean stress level of the entire population (at a 3% reproduction rate) remained at a dynamic equilibrium point. 
